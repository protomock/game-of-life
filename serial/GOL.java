...
public class GOL {
	...
	public IMatrixConstructor matrixConstructor;
	public INeighborCounter neighborCounter;

	public GOL(IMatrixConstructor matrixConstructor, INeighborCounter neighborCounter){
			this.matrixConstructor = matrixConstructor;
			this.neighborCounter = neighborCounter;
	}

	public void setup(){
			matrixConstructor.constuct();
	}

	public void isAlive(int row, int col) {
		int neighbors = 0;
